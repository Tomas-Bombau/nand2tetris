...
if __name__ == '__main__':
    ...
    for tokenizer in start:
        # outputASMFile = tokenizer.filePath.replace(".jack", ".xml")
        # newASMFile = CompilationEngine(tokenizer, outputASMFile)
        # newASMFile.CompileClass()
        outputVMFile = tokenizer.filePath.replace(".jack", ".vm")
        newVMFile = CompilationEngine(tokenizer, outputVMFile)
        newVMFile.CompileClass()
